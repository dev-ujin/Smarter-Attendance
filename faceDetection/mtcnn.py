...
from faceDetection.layer_factory import LayerFactory
from faceDetection.network import Network
from faceDetection.exceptions import InvalidImage
...
class MTCNN(object):
    ...
    def __init__(self, weights_file: str=None, min_face_size: int=20, steps_threshold: list=None,
        ...
        if weights_file is None:
            weights_file = pkg_resources.resource_stream('faceDetection', 'data/mtcnn_weights.npy')
